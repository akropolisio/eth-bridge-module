...
contract("ValidatorsOperation", async ([_, owner,  wallet1, wallet2, wallet3, wallet4, wallet5]) => {
   ...
   it("should transfer validatorship 1 => 1 correctly", async () => {
        await validatorsOperations.ChangeValidators([wallet1]);
   ...
   it("should transfer validatorship 1 => 2 correctly", async () => {
        await validatorsOperations.ChangeValidators([wallet1, wallet2]);
        (await validatorsOperations.validators(0)).should.be.equal(wallet1);
   ...
   it("should transfer validatorship 1 => 3 correctly", async () => {
        await validatorsOperations.ChangeValidators([wallet1, wallet2, wallet3]);
   ...
   it("should transfer validatorship 2 => 1 correctly", async () => {
        ...
        await validatorsOperations.ChangeValidators([wallet3], { from: wallet1 });
        await validatorsOperations.ChangeValidators([wallet3], { from: wallet2 });
   ...
   it("should transfer validatorship 3 => 1 correctly", async () => {
        await validatorsOperations.ChangeValidators([wallet1, wallet2, wallet3]);
        await validatorsOperations.ChangeValidators([wallet4], { from: wallet1 });
        await validatorsOperations.ChangeValidators([wallet4], { from: wallet2 });
        await validatorsOperations.ChangeValidators([wallet4], { from: wallet3 });
   ...
   it("should transfer validatorship 2 => 2 correctly", async () => {
        await validatorsOperations.ChangeValidators([wallet1, wallet2]);
        await validatorsOperations.ChangeValidators([wallet3, wallet4], { from: wallet1 });
        await validatorsOperations.ChangeValidators([wallet3, wallet4], { from: wallet2 });
   ...
   it("should transfer validatorship 2 => 3 correctly", async () => {
        await validatorsOperations.ChangeValidators([wallet1, wallet2]);
        await validatorsOperations.ChangeValidators([wallet3, wallet4, wallet5], { from: wallet1 });
        await validatorsOperations.ChangeValidators([wallet3, wallet4, wallet5], { from: wallet2 });
   ...
   it("should transfer validatorship 3 => 2 correctly", async () => {
        await validatorsOperations.ChangeValidators([wallet1, wallet2, wallet3]);
        await validatorsOperations.ChangeValidators([wallet4, wallet5], { from: wallet1 });
        await validatorsOperations.ChangeValidators([wallet4, wallet5], { from: wallet2 });
        await validatorsOperations.ChangeValidators([wallet4, wallet5], { from: wallet3 });
   ...
   it("should transfer validatorship 1,2 of 3 => 2 correctly", async () => {
        await validatorsOperations.ChangeValidatorsWithHowMany([wallet1, wallet2, wallet3], 2);
        await validatorsOperations.ChangeValidators([wallet4, wallet5], { from: wallet1 });
        await validatorsOperations.ChangeValidators([wallet4, wallet5], { from: wallet2 });
   ...
   it("should transfer validatorship 5 => 3 correctly", async () => {
        await validatorsOperations.ChangeValidatorsWithHowMany([wallet1, wallet2, wallet3, wallet4, wallet5], 3);
        (await validatorsOperations.validators(0)).should.be.equal(wallet1);
        (await validatorsOperations.validators(1)).should.be.equal(wallet2);
        await validatorsOperations.ChangeValidators([wallet4, wallet5], { from: wallet1 });
        await validatorsOperations.ChangeValidators([wallet4, wallet5], { from: wallet2 });
   ...
   it("should correctly manage allOperations array", async () => {
        ...
        (await validatorsOperations.allOperationsCount()).toNumber().should.be.equal(0);
        await validatorsOperations.ChangeValidators([wallet2, wallet3], { from: wallet1 });
        (await validatorsOperations.allOperationsCount()).toNumber().should.be.equal(0);
   ...
   it("should reset all pending operations when validators change", async () => {
        ...
        await validatorsOperationsMock.ChangeValidators([wallet3], { from: wallet1 });
        (await validatorsOperationsMock.allOperationsCount()).toNumber().should.be.equal(2);

        await validatorsOperationsMock.ChangeValidators([wallet3], { from: wallet2 });
   ...
   it("should allow to call onlyAllvalidators methods properly", async () => {
        ...
        await validatorsOperationsMock.ChangeValidatorsWithHowMany([wallet1, wallet2], 1);
   ...
   it("should not allow to transfer validatorship to no one and to user 0", async () => {
        ...
        await validatorsOperations.ChangeValidators([]).should.be.rejectedWith(EVMRevert);
        await validatorsOperations.ChangeValidators([ZERO_ADDRESS]).should.be.rejectedWith(EVMRevert);
        await validatorsOperations.ChangeValidators([ZERO_ADDRESS, wallet1]).should.be.rejectedWith(EVMRevert);
        await validatorsOperations.ChangeValidators([wallet1, ZERO_ADDRESS]).should.be.rejectedWith(EVMRevert);
        await validatorsOperations.ChangeValidators([ZERO_ADDRESS, wallet1, wallet2]).should.be.rejectedWith(EVMRevert);
        await validatorsOperations.ChangeValidators([wallet1, ZERO_ADDRESS, wallet2]).should.be.rejectedWith(EVMRevert);
        await validatorsOperations.ChangeValidators([wallet1, wallet2, ZERO_ADDRESS]).should.be.rejectedWith(EVMRevert);
    });
   ...
   it("should not allow to transfer validatorship to several equal users", async () => {
        ...
        await validatorsOperations.ChangeValidators([wallet1, wallet1]).should.be.rejectedWith(EVMRevert);
        await validatorsOperations.ChangeValidators([wallet1, wallet2, wallet1]).should.be.rejectedWith(EVMRevert);
    });

   it("should not allow to transfer validatorship to more than 256 validators", async () => {
       
        await validatorsOperations.ChangeValidators([
