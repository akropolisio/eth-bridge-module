...
contract ValidatorsOperations {
    ...
    */
    function cancelPending(bytes32 operation) public onlyAnyValidator {
        require((isExistValidator(msg.sender) && (validatorsIndices[msg.sender] <= validators.length)), 
        "checkHowManyvalidators: msg.sender is not an Validator");
    ...
    */
    function transferValidatorShipWithHowMany(address[] memory newValidators, uint256 newHowManyValidatorsDecide) public onlyManyValidators {
        ...
        "transferValidatorShipWithHowMany: newHowManyValidatorsDecide exceeds the number of Validators");
